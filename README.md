...
3. Upload ```weather.php``` to your server. Call the function ```get_weather($anyPlace)``` to get the weather. Done!
...
3. For more documentation of the api: <a>http://openweathermap.org/current</a>
